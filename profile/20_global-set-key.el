...
(global-set-key (kbd "C-j") 'helm-rg-project-root-or-default-empty)
...
(global-set-key (kbd "M-j") 'helm-rg-project-root-or-default)
...
(global-set-key (kbd "C-M-j") 'helm-rg-empty)
