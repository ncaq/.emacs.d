...
(global-set-key (kbd "C-;")	'align-regexp);align
(global-set-key (kbd "C-M-d")	'delete-horizontal-space);周辺の空白を全て削除
(global-set-key (kbd "C-S-q")	'recentf-open-most-recent-file-0);最後に閉じたバッファを開く
...
(global-set-key (kbd "C-o")	'find-file-at-point);C-xC-fは頻繁に打つにしてはめんどくさい
